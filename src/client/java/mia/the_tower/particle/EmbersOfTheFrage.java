...
public class EmbersOfTheFrage extends SpriteBillboardParticle {
    private final SpriteProvider sprites;

    public EmbersOfTheFrage(ClientWorld world, double x, double y, double z,
                            double vx, double vy, double vz, SpriteProvider sprites) {
        super(world, x, y, z, vx, vy, vz);
        this.sprites = sprites;
        this.scale *= this.random.nextFloat() * 0.6F + 1.5F;
        this.maxAge = (int)((double)1000.0F / (Math.random() * 0.8 + 0.2));
 ...
 */
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z,
            ...
            EmbersOfTheFrage particle = new EmbersOfTheFrage(world, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
