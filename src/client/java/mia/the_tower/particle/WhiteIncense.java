...
public class WhiteIncense extends SpriteBillboardParticle {
    private final SpriteProvider sprites;


    public WhiteIncense(ClientWorld world, double x, double y, double z,
 ...
 */
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z,
            ...
            WhiteIncense particle = new WhiteIncense(world, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
