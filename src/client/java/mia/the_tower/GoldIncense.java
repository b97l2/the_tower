...
public class GoldIncense extends SpriteBillboardParticle {
    private final SpriteProvider sprites;


    public GoldIncense(ClientWorld world, double x, double y, double z,
 ...
 */
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z,
            ...
            GoldIncense particle = new GoldIncense(world, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
